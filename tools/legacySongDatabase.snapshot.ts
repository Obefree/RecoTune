/** Archived full builtin catalog (~536). Not loaded into practice by default — see assets/archive. */

import type { SongEntry } from '../src/data/songDatabase';

export const LEGACY_ARCHIVE_SONGS: SongEntry[] = [
